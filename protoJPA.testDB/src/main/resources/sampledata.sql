...
CREATE TABLE Item(InvoiceID INTEGER,ItemID INTEGER,ProductID INTEGER,Quantity INTEGER,Cost DECIMAL,PRIMARY KEY(InvoiceID,ItemID), FOREIGN KEY (InvoiceID) REFERENCES Invoice (ID) ON DELETE CASCADE, FOREIGN KEY (ProductID) REFERENCES Product(ID) ON DELETE CASCADE);
